...
AGENT_REGISTRY = [
    ...
    {
        "number":   13,
        "name":     "GitKTIndexAgent",
        "module":   "ai_agents.reporting.gitkt_index_agent",
        "schedule": "1st of every month 06:00 UTC",
        "purpose":  "Aggregates all agent outputs into the monthly GitKT FinTech OSS Index (LaTeX/Markdown/JSON).",
        "writes":   "(GitKTIndex) + [:FEATURES_BREAKOUT], [:FLAGS_ACQUISITION], [:HIGHLIGHTS_SURGE] edges",
